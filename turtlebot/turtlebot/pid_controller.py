...
class pid_controller(Node):
    ...
    def pose_callback(self, data):
        ...
        self.pose_thetha = self.quat_to_euler(data.pose.pose.orientation)

        
    #update the reference/goal of the bot from the motion planner
    def ref_pose_callback(self, msg):
        self.goal_pose_x = msg.data[0]
        self.goal_pose_y = msg.data[1]
        self.goal_pose_theta = msg.data [2]
    ...
    def get_to_goal(self):
        ...
        if self.goal is None:
            ...
            if self.goal_x is None and self.goal_y is None % self.goal_theta is None:
                print('Reached Goal!')
                self.goal = None 
